...
/* harmony import */ var atom_package_deps__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(3);
/* harmony import */ var atom_package_deps__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(atom_package_deps__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var os__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(14);
...
/* harmony import */ var path__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(10);
/* harmony import */ var path__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(path__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var child_process__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(15);
...
/* harmony import */ var _package_json__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(16);
var _package_json__WEBPACK_IMPORTED_MODULE_6___namespace = /*#__PURE__*/__webpack_require__.t(16, 1);
'use babel';
...
function spawnPromise(cmd, args) {
  return new Promise(function (resolve, reject) {
    const child = Object(child_process__WEBPACK_IMPORTED_MODULE_5__["spawn"])(cmd, args);
    let stdOut;
    let stdErr;
...
function satisfyDependencies() {
  Object(atom_package_deps__WEBPACK_IMPORTED_MODULE_2__["install"])(_package_json__WEBPACK_IMPORTED_MODULE_6__.name);
  const packageDeps = _package_json__WEBPACK_IMPORTED_MODULE_6__['package-deps'];
...
function provideBuilder() {
  return class pynsistProvider extends events__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"] {
    constructor(cwd) {
      super();
      this.cwd = cwd;
    ...
    async isEligible() {
      if (atom.config.get(`${_package_json__WEBPACK_IMPORTED_MODULE_6__.name}.alwaysEligible`) === true) {
        return true;
      } // First, check for installer.cfg


      const projectPath = atom.project.getPaths()[0];
      const projectConfig = typeof projectPath !== 'undefined' ? Object(fs__WEBPACK_IMPORTED_MODULE_1__["existsSync"])(Object(path__WEBPACK_IMPORTED_MODULE_4__["join"])(projectPath, 'installer.cfg')) : false;
      const activeEditor = atom.workspace.getActiveTextEditor();
      const activePath = typeof activeEditor !== 'undefined' ? activeEditor.getPath() : false;
      const activeConfig = activePath !== false ? Object(fs__WEBPACK_IMPORTED_MODULE_1__["existsSync"])(Object(path__WEBPACK_IMPORTED_MODULE_4__["join"])(activePath, 'installer.cfg')) : false;
      const hasConfig = projectConfig || activeConfig ? true : false; // Second, check for pynsist

      const pathToPynsist = atom.config.get(`${_package_json__WEBPACK_IMPORTED_MODULE_6__.name}.pathToPynsist`);
      ...
      if (hasPynsist === false && atom.config.get(`${_package_json__WEBPACK_IMPORTED_MODULE_6__.name}.mutePathWarning`) === false) {
        const notification = atom.notifications.addWarning(`**${_package_json__WEBPACK_IMPORTED_MODULE_6__.name}**: No valid \`pynsist\` was specified in your settings`, {
          dismissable: true,
          buttons: [{
            text: 'Open Settings',
            className: 'icon icon-gear',
            onDidClick: function () {
              atom.workspace.open(`atom://config/packages/${_package_json__WEBPACK_IMPORTED_MODULE_6__.name}`, {
                pending: true,
                searchAllPanes: true
              });
            ...
            text: 'Ignore',
            onDidClick: function () {
              atom.config.set(`${_package_json__WEBPACK_IMPORTED_MODULE_6__.name}.mutePathWarning`, true);
              notification.dismiss();
            }
          }]
        });
...
function activate() {
  if (atom.config.get(`${_package_json__WEBPACK_IMPORTED_MODULE_6__.name}.manageDependencies`) === true) {
    satisfyDependencies();
  }
}
...
var _sbFs = _interopRequireDefault(__webpack_require__(6));
