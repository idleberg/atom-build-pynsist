...
/* harmony import */ var events__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(2);
/* harmony import */ var events__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(events__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(3);
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "config", function() { return _config__WEBPACK_IMPORTED_MODULE_2__["configSchema"]; });
...
/* harmony import */ var os__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(6);
...
/* harmony import */ var _util__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(7);
/* harmony import */ var child_process__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(18);
...
function provideBuilder() {
  return class pynsistProvider extends events__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"] {
    constructor(cwd) {
      super();
      this.cwd = cwd;
    ...
    async isEligible() {
      if (Object(_config__WEBPACK_IMPORTED_MODULE_2__["getConfig"])('alwaysEligible') === true) {
        return true;
      } // First, check for installer.cfg


      const projectPath = atom.project.getPaths()[0];
      const projectConfig = typeof projectPath !== 'undefined' ? Object(fs__WEBPACK_IMPORTED_MODULE_3__["existsSync"])(Object(path__WEBPACK_IMPORTED_MODULE_4__["join"])(projectPath, 'installer.cfg')) : false;
      const activeEditor = atom.workspace.getActiveTextEditor();
      const activePath = typeof activeEditor !== 'undefined' ? activeEditor.getPath() : false;
      const activeConfig = activePath !== false ? Object(fs__WEBPACK_IMPORTED_MODULE_3__["existsSync"])(Object(path__WEBPACK_IMPORTED_MODULE_4__["join"])(activePath, 'installer.cfg')) : false;
      const hasConfig = projectConfig || activeConfig ? true : false; // Second, check for pynsist

      const pathToPynsist = Object(_config__WEBPACK_IMPORTED_MODULE_2__["getConfig"])('pathToPynsist');
      const whichCmd = Object(child_process__WEBPACK_IMPORTED_MODULE_7__["spawnSync"])(Object(_util__WEBPACK_IMPORTED_MODULE_6__["which"])(), [pathToPynsist]);
      ...
      if (hasPynsist === false && Object(_config__WEBPACK_IMPORTED_MODULE_2__["getConfig"])('mutePathWarning') === false) {
        const notification = atom.notifications.addWarning(`**${_package_json__WEBPACK_IMPORTED_MODULE_0__.name}**: No valid \`pynsist\` was specified in your settings`, {
          dismissable: true,
          buttons: [{
            text: 'Open Settings',
            className: 'icon icon-gear',
            onDidClick: function () {
              atom.workspace.open(`atom://config/packages/${_package_json__WEBPACK_IMPORTED_MODULE_0__.name}`, {
                pending: true,
                searchAllPanes: true
              });
            ...
            text: 'Ignore',
            onDidClick: function () {
              atom.config.set(`${_package_json__WEBPACK_IMPORTED_MODULE_0__.name}.mutePathWarning`, true);
              notification.dismiss();
            }
          }]
        });
...
async function activate() {
  if (Object(_config__WEBPACK_IMPORTED_MODULE_2__["getConfig"])('manageDependencies') === true) {
    Object(_util__WEBPACK_IMPORTED_MODULE_6__["satisfyDependencies"])();
  }
}
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "configSchema", function() { return configSchema; });
...
/* harmony import */ var _package_json__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
var _package_json__WEBPACK_IMPORTED_MODULE_0___namespace = /*#__PURE__*/__webpack_require__.t(1, 1);
/* harmony import */ var atom_package_deps__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(8);
...
/* harmony import */ var os__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(6);
/* harmony import */ var os__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(os__WEBPACK_IMPORTED_MODULE_2__);



function satisfyDependencies() {
  Object(atom_package_deps__WEBPACK_IMPORTED_MODULE_1__["install"])(_package_json__WEBPACK_IMPORTED_MODULE_0__.name);
  const packageDeps = _package_json__WEBPACK_IMPORTED_MODULE_0__['package-deps'];
...
var _assert = _interopRequireDefault(__webpack_require__(9));

var Helpers = _interopRequireWildcard(__webpack_require__(10));
...
var _sbFs = _interopRequireDefault(__webpack_require__(11));

var _path = _interopRequireDefault(__webpack_require__(5));

var _semver = _interopRequireDefault(__webpack_require__(15));
...
var _stripBomBuf = _interopRequireDefault(__webpack_require__(13));
...
const isUtf8 = __webpack_require__(14);
